...
public class JtacPluginTool extends AbstractPluginTool implements Disposable {

    private final static String TAG = "JtacPluginTool";

    public JtacPluginTool(final Context context) {
        super(context,
                context.getString(R.string.app_name),
                context.getString(R.string.app_name),
                context.getResources().getDrawable(R.drawable.ic_launcher),
                "com.atakmap.android.jtac_plugin.SHOW_HELLO_WORLD");
    ...
    private final BroadcastReceiver br = new BroadcastReceiver() {
        ...
        public void onReceive(Context c, Intent intent) {
            ...
            NavButtonModel mdl = NavButtonManager.getInstance()
                    .getModelByPlugin(JtacPluginTool.this);
            if (mdl != null) {
