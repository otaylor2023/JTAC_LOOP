 ...
 * Needs to be its own class because you can't access AtakBroadcast inside JtacPluginDropDownReceiver
...
public class SpeechDetailOpener {
     ...
     * @param view - view from the JtacPluginDropDownReceiver. Needed to get the self marker. And to get the mapGroups
     */
