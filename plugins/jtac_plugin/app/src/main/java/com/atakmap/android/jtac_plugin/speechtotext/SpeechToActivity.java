...
package com.atakmap.android.jtac_plugin.speechtotext;
 ...
 * to the JtacPluginDropDownReceiver.
 */
public class SpeechToActivity extends Activity {
    //These are the intents for JtacPluginDropDownReceiver
    ...
    public static final String QUICK_INTENT = "com.atakmap.android.jtac_plugin.QUICKINTENT";
    public static final String NAVIGATE_SPEECH_INFO = "com.atakmap.android.jtac_plugin.NAVIGATESPEECHINFO";
    public static final String ACTIVITY_INFO_BUNDLE = "com.atakmap.android.jtac_plugin.ACTIVITYINFOBUNDLE";
    public static final String DESTINATION = "com.atakmap.android.jtac_plugin.DESTINATION";
    public static final String EMERGENCY_TYPE = "com.atakmap.android.jtac_plugin.EMERGENCYTYPE";
    public static final String ACTIVITY_INTENT = "com.atakmap.android.jtac_plugin.ACTIVITY";
     ...
     * activities bundle gets sent back to JtacPluginDropDownReceiver
    ...
    /**
     * Sends out returnIntent back to JtacPluginDropDownReceiver
     */
     ...
     * here(or there in JtacPluginDropDownReceiver rather)
     *
     */
