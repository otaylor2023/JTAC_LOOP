...
package com.atakmap.android.jtac_plugin.notification;

import com.atakmap.android.jtac_plugin.plugin.BuildConfig;
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel(
                    "com.atakmap.android.jtac_plugin.def",
        ...
        atakFrontIntent.putExtra("internalIntent",
                new Intent("com.atakmap.android.jtac_plugin.SHOW_HELLO_WORLD"));
